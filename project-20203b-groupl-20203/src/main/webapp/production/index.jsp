      ...
      <div class="main_container">
        <!-- top navigation -->
         <header id="top_nav" style="height:70px; background:#787878;">
  			<nav id="banner" style="height:100px;" class="navbar navbar-dark bg-secondary justify-content-left">
		      	...
		      	<div>
					...
					<form name="formname" action="/dashboard" method="POST" style="margin: 10px 0px 2px 0px;">
						...
						<button id="logout-button" type="submit" class="btn btn-primary btn-md justify-content-right">
          ...
          <div class="row">
            ...
            <div class="col-md-6 col-sm-6 ">
              <div class="x_panel">
                ...
                <!-- Button trigger modal -->
					<button type="button"  style="border:none; border-radius:5px;" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal">Add by CSV</button>
	                              ...
	                              <p style="text-align:left;display:inline;">   Calculate in Portfolio: </p><p style="text-align:left; display:inline; font-weight:bold;">
									<form name="formname" id="stockDisplay-<%=myStocks.get(i).get(0)%>" action="/dashboard" method="POST">
										...
										<input type="hidden" name="ticker" value="<%=myStocks.get(i).get(0) %>">
		 								<button style="text-align:left;display:inline;" type="submit" id="displayButton-<%=myStocks.get(i).get(0)%>" class="btn btn-secondary btn-sm"><%=myStocks.get(i).get(5) %></button>
       								</form>
                           ...
                           <form name="formname" action="/dashboard" method="POST">
                              ...
                              <div class="inputrow" style="width: 100%;">
	                            <input type="hidden" name="action" value="addStock">
	                              <div style="float: left; width: 45%; margin-right:2.5%; margin-left:2.5%; display:table-cell;">
	                                <div style="margin-right:5px;">
	                                  <p style="text-align:center;">Ticker*</p>
	                                  <input class="stockinput" type="text" id="add-stock-ticker" name="ticker" style="width: 100%;" required>
	                                </div>
	                              </div>
	                              <div style="float: left; width: 45%; margin-left:2.5%; display:table-cell;">
	                                <div style="margin-right:5px;">
	                                  <p style="text-align:center;"># Shares*</p>
	                                  <input class="stockinput" type="text" id="add-stock-shares" name="numOfShares" style="width: 100%;" required>
	                                </div>
	                              </div>
	                            </div>
	                            <br>
	                            <div class="inputrow" style="width: 100%;">
	                              <div style="float: left; width: 45%; margin-right:2.5%; margin-left:2.5%; display:table-cell;">
	                                <div style="margin-right:5px;">
	                                  ...
	                                  <input class="stockinput" type="date" id="add-stock-datePurchased" name="datePurchased" style="width: 100%;" required>
	                                </div>
	                              </div>
	                              <div style="float: left; width: 45%; margin-left:2.5%; display:table-cell;">
	                                <div style="margin-right:5px;">
	                                  <p style="text-align:center;">Date Sold</p>
	                                  <input class="stockinput" type="date" id="add-stock-dateSold" name="dateSold" style="width: 100%;">
	                                </div>
	                              </div>
	                              <div style="float: left; width: 95%; margin-left:2.5%; margin-top:4%; display:table-cell;">
	                                <div style="margin-right:5px;">
            ...
            <!-- End to do list -->
			  ...
			  <div class="col-md-6 col-sm-6  bg-white" style="margin-bottom:10px;">
			  		<!-- <form name="formname" action="/dashboard" method="POST">
					...
					<%if(view!=null){for(int i=0; i<view.size(); i++) {%>
						<div style="float: left; width: 85%; background-color:#f3f3f3; padding:7px; margin-bottom:5px;">
                           <div style="display:inline;">
							 ...
							 <form name="formname" action="/dashboard" method="POST">
	                            ...
	                            <button id="btn-view-toggle<%=view.get(i).get(0) %>" class="btn btn-secondary btn-sm" style="text-align:left; display:inline; font-weight:bold;">Toggle on Graph</button>
	                         </form>
                            <%--  <form name="formname" action="/dashboard" method="POST">
	                         ...
	                         <form style="text-align:left; display:inline; font-weight:bold;" name="formname" action="/dashboard" method="POST">
	                         	<input type="hidden" name="ticker" value=<%=view.get(i).get(0) %>>
	                            ...
	                            <input type="hidden" name="action" value="addStock">
	                       	 	<button id="btn-view-add<%=view.get(i).get(0) %>" type="submit" class="btn btn-secondary btn-sm" style="text-align:left; display:inline; font-weight:bold;">Add to Portfolio</button>
                             </form>
                             
                             <div style="display:inline; text-align: left;">
	                            <button type="button" id="view-removeStockButton-<%=view.get(i).get(0)%>" class="btn btn-light btn-sm" style="text-align:left; display:inline; font-weight:bold; background:red; color:white;" data-toggle="modal" data-target="#view-removeStockModal-<%=view.get(i).get(0)%>">Remove</button>
	                            <!-- Modal for Remove Stock -->
                              ...
                              <div class="inputrow" style="width: 100%;">
	                            <input type="hidden" name="action" value="viewStock">
	                              <div style="float: left; width: 45%; margin-right:2.5%; margin-left:2.5%; display:table-cell;">
	                                <div style="margin-right:5px;">
	                                  <p style="text-align:center;">Ticker*</p>
	                                  <input class="stockinput" type="text" id="view-ticker" name="ticker" style="width: 100%;" required>
	                                </div>
	                              </div>
	                              <div style="float: left; width: 45%; margin-left:2.5%; display:table-cell;">
	                                <div style="margin-right:5px;">
	                                  <p style="text-align:center;"># Shares*</p>
	                                  <input class="stockinput" type="text" id="view-shares" name="numOfShares" style="width: 100%;" required>
	                                </div>
	                              </div>
	                            </div>
	                            <br>
	                            <div class="inputrow" style="width: 100%;">
	                              <div style="float: left; width: 45%; margin-right:2.5%; margin-left:2.5%; display:table-cell;">
	                                <div style="margin-right:5px;">
	                                  <p style="text-align:center;">Date Purchased*</p>
	                                  <input class="stockinput" type="date" id="view-datePurchased" name="datePurchased" style="width: 100%;" required>
	                                </div>
	                              </div>
	                              <div style="float: left; width: 45%; margin-left:2.5%; display:table-cell;">
	                                <div style="margin-right:5px;">
	                                  <p style="text-align:center;">Date Sold</p>
	                                  <input class="stockinput" type="date" id="view-dateSold" name="dateSold" style="width: 100%;">
	                                </div>
	                              </div>
	                              <div style="float: left; width: 95%; margin-left:2.5%; margin-top:4%; display:table-cell;">
	                                <div style="margin-right:5px;">
